package io.github.kmenager.sunshine.app.sync;
...
import io.github.kmenager.sunshine.app.R;
import io.github.kmenager.sunshine.app.Utility;
import io.github.kmenager.sunshine.app.data.WeatherContract;
import io.github.kmenager.sunshine.app.muzei.WeatherMuzeiSource;

public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    public final String LOG_TAG = SunshineSyncAdapter.class.getSimpleName();
    public static final String ACTION_DATA_UPDATED =
            "io.github.kmenager.sunshine.app.ACTION_DATA_UPDATED";
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        String countryCodeQuery = Utility.getPreferredCountryCode(getContext());
        String queryParam = locationQuery + "," + countryCodeQuery;
                ...
                if (cursor.moveToFirst()) {
                    ...
                    if (Utility.usingLocalGraphics(context)) {
                        largeIcon = BitmapFactory.decodeResource(resources,
                                Utility.getArtResourceForWeatherConditionNotification(weatherId));
                    } else {
