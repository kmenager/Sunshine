...
// Retrieve all of the Today widget ids: these are the widgets we need to update
        ...
        int[] appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(this,
                io.github.kmenager.sunshine.app.widget.TodayWidgetProvider.class));
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            int largeInterWidth = getResources().getDimensionPixelSize(R.dimen.widget_today_large_intermediate_width);
            int layoutId;
            if (widgetWidth >= largeWidth) {
                layoutId = R.layout.widget_today_large;
            } else if (widgetWidth >= largeInterWidth) {
                layoutId = R.layout.widget_today_large_intermediate;
